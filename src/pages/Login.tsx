            ...
            <form className="space-y-6" onSubmit={handleSubmit(submitForm)}>
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label htmlFor="email" className="block text-sm font-oswald-regular leading-6 text-gray-900">
                    Account
                  </label>
                </div>
                <div className="mt-2">
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label htmlFor="password" className="block text-sm font-oswald-regular leading-6 text-gray-900">
                    Password
                  </label>
                </div>
                <div className="mt-2">
              ...
              <button
                type="submit"
                disabled={loading}
                className="login-button flex w-full justify-center rounded-md bg-green-500 px-3 py-1.5 text-sm font-oswald-bold leading-6 text-white shadow-sm hover:bg-emerald-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Sign in
              </button>
            </form>
